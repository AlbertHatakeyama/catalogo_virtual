            ...
            <?php
            //SCRIPT PARA FAZER RODAR O BOT�O DIRETO NA LINHA <th>
            ?>
            <script>
                $(function(){     
            ...
            <script>
                //INCLUI A SETA AO LADO DO BOT�O, AVISANDO AO USU�RIO QUE ELE PRECISA CLICAR PARA SALVAR AS ALTERA��ES
...
<?php
//DEFINE AS CORES DAS LINHAS NAS P�GINAS DE LISTAGEM DE REGISTROS COMO POR EXEMPLO leads-lista.php
?>
<script>
