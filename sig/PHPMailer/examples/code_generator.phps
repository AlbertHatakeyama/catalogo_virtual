...
try {
    if (isset($_POST["submit"]) && $_POST['submit'] == "Submit") {
        ...
        $mail->addAttachment('assets/images/phpmailer_mini.png', 'phpmailer_mini.png'); // optional name
        $mail->addAttachment('assets/images/phpmailer.png', 'phpmailer.png'); // optional name
