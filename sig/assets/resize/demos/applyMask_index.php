<?php
  ...
  **/
	...
	$left = Request::getRegex('left', Registry::get('image dim regex'), '0');
	$top = Request::getRegex('top', Registry::get('image dim regex'), 0);
?>
...
?>
		...
		<td>
			<img src="assets/images/mask-<?php echo $mask; ?>.gif" />
		</td>
		<td>
